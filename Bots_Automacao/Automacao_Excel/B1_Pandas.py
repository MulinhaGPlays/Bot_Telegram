...
tabela = pd.read_excel("Bots_Automacao/Automacao_Excel/Planilhas/P1.xlsx") # Leitura do arquivo Excel
...
tabela.to_excel("Bots_Automacao/Automacao_Excel/Planilhas/P1_AlterPandas.xlsx") # Salvar alteraçõe no arquivo Excel ou criar um novo arquivo